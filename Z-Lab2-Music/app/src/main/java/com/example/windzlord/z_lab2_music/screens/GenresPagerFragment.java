...
import com.example.windzlord.z_lab2_music.managers.RecyclerViewListener;
 ...
 */
public class GenresPagerFragment extends Fragment {

    @BindView(R.id.recycler_view_type)
    RecyclerView recyclerViewType;

    public GenresPagerFragment() {
    ...
    private void getContent() {
        ...
        recyclerViewType.addOnItemTouchListener(new RecyclerViewListener(
            ...
            public void onItemClick(View view, int position) {
                ...
                EventBus.getDefault().post(new FragmentEvent(songsFragment, true));
            }
